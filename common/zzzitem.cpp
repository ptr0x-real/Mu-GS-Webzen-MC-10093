...
void CItem::Clear()
{
	...
	m_iPShopValue = -1;			// 이 값이 -1 이면 물건은 팔리지 않는다. (사용자가 아직 정의하지 않은 것이므로)
#endif

#ifdef ITEMDELETE_MODIFY_20040604	// 아이템 속성 중 아이템이 존재하는 아이템인가 아닌가에 대한 플래그 (초기화)
	m_bItemExist = true;
#endif
	...
	m_JewelOfHarmonyOption = 0;		// 조화의보석에 의한 추가 옵션
#endif

#ifdef ADD_380ITEM_NEWOPTION_20060711
	m_ItemOptionEx = 0; // 아이템 추가 옵션 : 상위 1bit 380 아이템 추가옵션
#endif

...
// 스탯이 빠졌을 경우만 생각해준다!!!!!!
	...
	if( lpObj->Class == CLASS_ELF )
	{
		...
		{	// 요정 활을 차고 있으면 민첩만 적용
			...
			{	// 장착 가능한 아이템이 아니면 적용하지 않는다
				lpObj->m_AttackDamageMinRight = (Dexterity+Strength)/g_GlobalConfig.AttackDamageMin_Bow_StrDexDiv_Elf;
				lpObj->m_AttackDamageMaxRight = (Dexterity+Strength)/g_GlobalConfig.AttackDamageMax_Bow_StrDexDiv_Elf;
				lpObj->m_AttackDamageMinLeft  = (Dexterity+Strength)/g_GlobalConfig.AttackDamageMin_Bow_StrDexDiv_Elf;
				lpObj->m_AttackDamageMaxLeft  = (Dexterity+Strength)/g_GlobalConfig.AttackDamageMax_Bow_StrDexDiv_Elf;
			}
			else
			{
				lpObj->m_AttackDamageMinRight = Dexterity/g_GlobalConfig.AttackDamageMin_NoBow_DexDiv_Elf+Strength/g_GlobalConfig.AttackDamageMin_NoBow_StrDiv_Elf;
				lpObj->m_AttackDamageMaxRight = Dexterity/g_GlobalConfig.AttackDamageMax_NoBow_DexDiv_Elf+Strength/g_GlobalConfig.AttackDamageMax_NoBow_StrDiv_Elf;
				lpObj->m_AttackDamageMinLeft  = Dexterity/g_GlobalConfig.AttackDamageMin_NoBow_DexDiv_Elf+Strength/g_GlobalConfig.AttackDamageMin_NoBow_StrDiv_Elf;
				lpObj->m_AttackDamageMaxLeft  = Dexterity/g_GlobalConfig.AttackDamageMax_NoBow_DexDiv_Elf+Strength/g_GlobalConfig.AttackDamageMax_NoBow_StrDiv_Elf;
			}
		}
		else
		{
			lpObj->m_AttackDamageMinRight = (Dexterity+Strength)/g_GlobalConfig.AttackDamageMin_DexStrDiv_Elf;
			lpObj->m_AttackDamageMaxRight = (Dexterity+Strength)/g_GlobalConfig.AttackDamageMax_DexStrDiv_Elf;
			lpObj->m_AttackDamageMinLeft  = (Dexterity+Strength)/g_GlobalConfig.AttackDamageMin_DexStrDiv_Elf;
			lpObj->m_AttackDamageMaxLeft  = (Dexterity+Strength)/g_GlobalConfig.AttackDamageMax_DexStrDiv_Elf;
		}
	}
	else if( lpObj->Class == CLASS_KNIGHT )
	{
		lpObj->m_AttackDamageMinRight = Strength/g_GlobalConfig.AttackDamageMin_StrDiv_DK;
		lpObj->m_AttackDamageMaxRight = Strength/g_GlobalConfig.AttackDamageMax_StrDiv_DK;
		lpObj->m_AttackDamageMinLeft  = Strength/g_GlobalConfig.AttackDamageMin_StrDiv_DK;
		lpObj->m_AttackDamageMaxLeft  = Strength/g_GlobalConfig.AttackDamageMax_StrDiv_DK;	
	}
	else if( lpObj->Class == CLASS_MAGUMSA )
	{
		lpObj->m_AttackDamageMinRight = Strength/g_GlobalConfig.AttackDamageMin_StrDiv_MG+Energy/g_GlobalConfig.AttackDamageMin_EneDiv_MG;
		lpObj->m_AttackDamageMaxRight = Strength/g_GlobalConfig.AttackDamageMax_StrDiv_MG+Energy/g_GlobalConfig.AttackDamageMax_EneDiv_MG;
		lpObj->m_AttackDamageMinLeft  = Strength/g_GlobalConfig.AttackDamageMin_StrDiv_MG+Energy/g_GlobalConfig.AttackDamageMin_EneDiv_MG;
		lpObj->m_AttackDamageMaxLeft  = Strength/g_GlobalConfig.AttackDamageMax_StrDiv_MG+Energy/g_GlobalConfig.AttackDamageMax_EneDiv_MG;	
	}
#ifdef DARKLORD_WORK	
	else if( lpObj->Class == CLASS_DARKLORD )
		{
			lpObj->m_AttackDamageMinRight = Strength/g_GlobalConfig.AttackDamageMin_StrDiv_DL+Energy/g_GlobalConfig.AttackDamageMin_EneDiv_DL;
			lpObj->m_AttackDamageMaxRight = Strength/g_GlobalConfig.AttackDamageMax_StrDiv_DL+Energy/g_GlobalConfig.AttackDamageMax_EneDiv_DL;
			lpObj->m_AttackDamageMinLeft  = Strength/g_GlobalConfig.AttackDamageMin_StrDiv_DL+Energy/g_GlobalConfig.AttackDamageMin_EneDiv_DL;
			lpObj->m_AttackDamageMaxLeft  = Strength/g_GlobalConfig.AttackDamageMax_StrDiv_DL+Energy/g_GlobalConfig.AttackDamageMax_EneDiv_DL;
		}	
#endif
	...
	{
		lpObj->m_AttackDamageMinRight = Strength/g_GlobalConfig.AttackDamageMin_StrDiv_DW;
		lpObj->m_AttackDamageMaxRight = Strength/g_GlobalConfig.AttackDamageMax_StrDiv_DW;
		lpObj->m_AttackDamageMinLeft  = Strength/g_GlobalConfig.AttackDamageMin_StrDiv_DW;
		lpObj->m_AttackDamageMaxLeft  = Strength/g_GlobalConfig.AttackDamageMax_StrDiv_DW;
	}	
...
//		lpObj->pInventory[EQUIPMENT_WEAPON_RIGHT].PlusSpecialPercent(&lpObj->m_MagicDamageMax,AT_IMPROVE_MAGIC, 2);
	...
	if(lpObj->Class == CLASS_ELF)
    {
		lpObj->m_AttackSpeed = Dexterity/g_GlobalConfig.AttackSpeed_Elf;
        lpObj->m_MagicSpeed = Dexterity/g_GlobalConfig.MagicSpeed_Elf;
    }
    //  기사. 마검사.
	else if(lpObj->Class == CLASS_KNIGHT || 
            lpObj->Class == CLASS_MAGUMSA )  //  20 --> 18
    {
		lpObj->m_AttackSpeed = Dexterity/g_GlobalConfig.AttackSpeed_DK_MG;
        lpObj->m_MagicSpeed = Dexterity/g_GlobalConfig.MagicSpeed_DK_MG;
    }
    //  법사.
#ifdef DARKLORD_WORK	
		else if(lpObj->Class == CLASS_DARKLORD )
		{
			lpObj->m_AttackSpeed = Dexterity/g_GlobalConfig.AttackSpeed_DL;
			lpObj->m_MagicSpeed = Dexterity/g_GlobalConfig.MagicSpeed_DL;
		}
#endif
    ...
    {
		lpObj->m_AttackSpeed = Dexterity/g_GlobalConfig.AttackSpeed_DW;
		lpObj->m_MagicSpeed = Dexterity/g_GlobalConfig.MagicSpeed_DW;
    }
	...
	if( lpObj->Class == CLASS_ELF )
	{
		lpObj->m_SuccessfulBlocking = Dexterity/g_GlobalConfig.SuccessfulBlocking_Elf;
	}
#ifdef DARKLORD_WORK
	else if( lpObj->Class == CLASS_DARKLORD )
	{
		lpObj->m_SuccessfulBlocking = Dexterity/g_GlobalConfig.SuccessfulBlocking_DL;
	}
#endif
	...
	{
		lpObj->m_SuccessfulBlocking = Dexterity/g_GlobalConfig.SuccessfulBlocking_DW_DK_MG;
	}
	...
	// Defense
		if(lpObj->Class == CLASS_ELF)
     		lpObj->m_Defense  = Dexterity/g_GlobalConfig.Defense_Elf;
		else if(lpObj->Class == CLASS_KNIGHT )
     		lpObj->m_Defense  = Dexterity/g_GlobalConfig.Defense_DK;
			...
			lpObj->m_Defense  = Dexterity/g_GlobalConfig.Defense_DL;
		#endif	// DARKLORD_WORK
		...
		else if(lpObj->Class == CLASS_SUMMONER )
		{
			...
			lpObj->m_Defense  = Dexterity/g_GlobalConfig.Defense_DW_MG;

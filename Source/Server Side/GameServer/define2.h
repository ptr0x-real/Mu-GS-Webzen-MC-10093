...
#ifndef FOR_TAIWAN
	#define GAMESEVER_VERSION	"1.00.87"			// 게임서버 버전
#else
	#define GAMESEVER_VERSION	"1.00.87d"			// 대만 게임서버 버전
#endif //FOR_TAIWAN
...
//	#define EVENT_SONGKRAN_2005_20050316                           
	...
	// 새로운 피로도 시스템 추가 (RKFKA) - 베트남 정부규제에 따른 시스템 변경
	#define VTM_NEW_PLAYTIME_LIMIT_SYSTEM_20061127
	...
	#define ADD_ANTI_HACK_01_20051027
...
// 테스트 서버에 적용되는 것들은 여기에 추가!!!!!
	...
	// [버그수정] Listen socket 오류시 무한 루프 버그 수정(grooving)
	#define MODIFY_BUGFIX_IOCPSERVERWORKER_20090330
...
//	#define MODIFY_ADDMONSTER_ADDLOCK_20080117
	...
	#ifndef MODIFY_SEASON_02_20060908
...
//해외로 빌드시 컴파일 에러가 발생하여 임시로 상위 디파인조건을 추가함 - riverstyx
	...
	// [버그수정] 환영사원 보상경험치 풍요의 인장 제거(goni)
...
#define MAX_LEVEL					400		// 레벨 최대 크기
	...
	#define MAX_ITEMLEVEL			13		// 레벨 최대 크기
#else
	#define MAX_ITEMLEVEL			11		// 레벨 최대 크기
#endif
